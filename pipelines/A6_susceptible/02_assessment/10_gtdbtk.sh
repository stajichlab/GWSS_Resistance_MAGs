...
#SBATCH -o logs/10_gtbtdk_A.log
#SBATCH -e logs/10_gtbtdk_A.log
...
INPUT=/rhome/cassande/shared/projects/SharpShooter/GWSS_Wolbachia/GWSS_A/GWSS_A_SAMPLES_MERGED/sample_summary_DASTOOL/bin_fasta/
